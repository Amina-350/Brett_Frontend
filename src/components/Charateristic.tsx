...
export default function Charateristic() {
  return (
    <>
    <div  className={`${koulenFont.className} main-precel-bounces pt-[60vh] pb-[25vh] main-charateristic`}>
        <div className="submain-precel-bounces relative ">
<Image src={eightthreedancing} alt='eightthreedancing' className='w-[20vw] h-[40vh] absolute top-[-63vh] left-[13vw]'/>
<Image src={alian7} alt='alian7' className='w-[20vw] h-[40vh] absolute top-[-16vh]'/>
<Image src={adzrism} alt='adzrism' className='w-[40vw] h-[80vh] absolute top-[-57vh] left-[33vw]'/>
...
<div className="main-inner-charateristics-section w-[75vw] mx-auto flex flex-col flex-wrap justify-center items-center pt-[10vh]">
    ...
    <p className='text-white'>Not Just a MemeCoin — A Blockchain Revolution: Layer Brett</p>
    <Image src={speed} alt='speed' className='w-[40vw] h-[15vh]'/>
</div>
<div className="sub-section-charateristic-list flex gap-4  flex-wrap">
  ...
  <div className="img-sec-div p-2 bg-[#FFB3E8] h-[30px] w-[35px] border-[2px] border-[#EF53C0C0] rounded flex justify-center items-center shadow-[-6px_4px_0_#003e58]">
            ...
            <p className={`${NunitoFont.className} text-white`} >No more waiting. With Layer 2 technology, Layer Brett processes transactions at lightning speed, ensuring seamless staking, trading, and interactions across the ecosystem.</p>
  ...
  <div className="img-sec-div p-2 bg-[#FFB3E8] h-[30px] w-[35px] border-[2px] border-[#EF53C0C0] rounded flex justify-center items-center shadow-[-6px_4px_0_#003e58]">
            ...
            <p className={`${NunitoFont.className} text-white`} >Unleash the potential of smart contracts. Layer Brett supports advanced programmability, enabling developers to build unique dApps and experiences within the ecosystem.</p>
