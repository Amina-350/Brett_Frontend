...
export default function Brettwar() {
  return (
    <>
      <div
        className={`${koulenFont.className} main-brett-war pt-[10vh] pb-[19vh]`}
      >
        ...
        {/* give away */}
        <div
          className={` transcation-image-sec11 z-20 bg-[#0487ab] pt-4 pl-5 pr-5 pb-2 border-[4px] border-[#003e58] rounded  w-[55vw] mx-auto -mt-[70px]`}
        >
          <div className="main-symbol-table flex justify-between items-center flex-wrap relative">
            ...
            <div className="transcation-image-sec transcation-image-sec1 flex justify-start items-center gap-1 bg-[#0487AB] absolute top-[3vh] left-[14%] p-1 border-[#003E58] border-[2px] rounded">
              <div className="img-sec-div img-sec-div1 p-2 bg-[#FFB3E8] h-[10vh] w-[6vw] border-[2px] border-[#EF53C0C0] rounded flex justify-center items-center shadow-[-6px_4px_0_#003e58]">
                <Image src={one} alt="img-1" className=" img-sec-div-one h-[50px] w-[50px]" />
              </div>
              <p className="text-dark [-webkit-text-stroke:1px_#D6FF00] mt-3 text-[4vw] mb-0 pb-0 mt-0 million-giveaway">
                Million Giveaway
              </p>
            </div>
            <div className=" absolute buy-and-stake buy-and-stake2 border-[2px] border-[#f36bca] bg-[#FFB3E8] rounded shadow-[-8px_8px_0_#003e58] top-[55%] left-[28%] ">
              <p className="buy-and-stake2-text text-[#FFFFFF7D] text-[18px] text-center text-dark mb-1 mt-1 w-[20vw] ">
                Enter Giveaway
              </p>
            </div>
          </div>
        ...
        <Container className="mt-1 mb-0 p-0 ml-[70px] relative">
          <div className="flex cal-section-div flex-wrap justify-between items-center gap-4 ml-[10px] mr-[50px] w-[48vw] absolute mt-[-16vh] left-[20vw]">
            {/* First Section */}
            <div className="flex items-center">
              <Image
                ...
                width={55}
                height={50}
                className="ml-4 ractangle5"
              />
            </div>

            {/* Second Section */}
            <div className="flex justify-center items-center gap-2 ml-[60px] mt-[40px]">
              <Image src={ractangle} alt="rectangle" width={50} height={50} className="ractangle1"/>
              <Image src={ractangle} alt="rectangle" width={50} height={50}  className="ractangle2" />
            </div>

            {/* Third Section */}
            <div className="flex justify-center items-center gap-2 ml-4">
              <Image src={rectangle2} alt="rectangle2" width={50} height={50}  className="ractangle3" />
              <Image src={rectangle2} alt="rectangle2" width={50} height={50}  className="ractangle4" />
            </div>
          </div>
          <Image
            src={facehunger}
            alt="facehunger"
            className="absolute top-[-27vh] left-[59%] w-[25vw] h-[45vh] "
          />
        </Container>
